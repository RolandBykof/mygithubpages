...
!function(){
  ...
  var select2Observer = new MutationObserver(function(mutations) {
    ...
    // Jos uutta potentiaalista sisältöä lisättiin, yritetään ajaa korjaukset
    if (shouldCheck) {
      fixSelect2InDOM(document, window);
    }
  });

  // Aloitetaan tarkkailu koko sivun rungolle (body)
